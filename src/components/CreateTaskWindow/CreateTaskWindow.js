...
function CreateTaskWindow ({task, isOpen, onBackgroundClick}) {
    ...
    return (
        <>
            {isOpen && (<>
                <section className="create-window-main-container" style={windowStyle}>
                    <div className='task-title-exs-container'>
                        <input className='task-title-input' placeholder='Title 📚'></input>
                        <i className='pi pi-times' onClick={onBackgroundClick}></i>
                    </div>
                ...
                <div className='overlay-popup' style={windowStyle} onClick={onBackgroundClick}></div>
            </>)}
